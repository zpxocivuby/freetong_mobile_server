 ...
 * @author Danne
 */
@Component("businessExceptionMsgServiceImpl")
public class BusinessExceptionMsgServiceImpl extends
		ResourceBundleMessageSource implements IExceptionMsgService {

	/* bundle name */
	private static final String BUNDLE_NAME = "business-exception";
	 ...
	 * 
	 */
	public BusinessExceptionMsgServiceImpl() {
		this(BusinessExceptionMsgServiceImpl.class.getPackage().getName() + "."
				+ BUNDLE_NAME);
	}
	 ...
	 */
	protected BusinessExceptionMsgServiceImpl(String bundleName) {
