 ...
 * generated in the itaf.WsUserDeliveryAddressService package. 
...
public class ObjectFactory {
    ...
    private static final QName _DeleteByIdResponse_QNAME = new QName("itaf.framework.ws.server.merchant", "deleteByIdResponse");
    private static final QName _GetById_QNAME = new QName("itaf.framework.ws.server.merchant", "getById");
    private static final QName _SaveOrUpdateResponse_QNAME = new QName("itaf.framework.ws.server.merchant", "saveOrUpdateResponse");
    private static final QName _FindListByUserIdResponse_QNAME = new QName("itaf.framework.ws.server.merchant", "findListByUserIdResponse");
    private static final QName _GetByIdResponse_QNAME = new QName("itaf.framework.ws.server.merchant", "getByIdResponse");
    private static final QName _SaveOrUpdate_QNAME = new QName("itaf.framework.ws.server.merchant", "saveOrUpdate");
    private static final QName _FindListByUserId_QNAME = new QName("itaf.framework.ws.server.merchant", "findListByUserId");
    private static final QName _DeleteById_QNAME = new QName("itaf.framework.ws.server.merchant", "deleteById");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: itaf.WsUserDeliveryAddressService
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.merchant", name = "deleteByIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.merchant", name = "saveOrUpdateResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.merchant", name = "findListByUserIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.merchant", name = "saveOrUpdate")
     ...
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.merchant", name = "findListByUserId")
     ...
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.merchant", name = "deleteById")
