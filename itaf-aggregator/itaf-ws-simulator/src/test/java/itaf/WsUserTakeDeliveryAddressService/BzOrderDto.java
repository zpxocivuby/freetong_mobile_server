 ...
 *       &lt;sequence>
 *         &lt;element name="sysUserByBzConsumerIdDto" type="{itaf.framework.ws.server.consumer}sysUserDto" minOccurs="0"/>
 *         &lt;element name="sysUserByBzMerchantIdDto" type="{itaf.framework.ws.server.consumer}sysUserDto" minOccurs="0"/>
 *         &lt;element name="bzUserTakeDeliveryAddressDto" type="{itaf.framework.ws.server.consumer}bzUserTakeDeliveryAddressDto" minOccurs="0"/>
 ...
 *         &lt;element name="bzConsumerCreditEvalDtos" type="{itaf.framework.ws.server.consumer}bzConsumerCreditEvalDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzOrderHistorieDtos" type="{itaf.framework.ws.server.consumer}bzOrderHistoryDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzDistComCreditEvalDtos" type="{itaf.framework.ws.server.consumer}bzDistComCreditEvalDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzOrderPaymentDtos" type="{itaf.framework.ws.server.consumer}bzOrderPaymentDto" maxOccurs="unbounded" minOccurs="0"/>
