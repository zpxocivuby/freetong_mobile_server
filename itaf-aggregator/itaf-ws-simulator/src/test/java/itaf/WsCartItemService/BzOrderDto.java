 ...
 *       &lt;sequence>
 *         &lt;element name="sysUserByBzConsumerIdDto" type="{itaf.framework.ws.server.cart}sysUserDto" minOccurs="0"/>
 *         &lt;element name="sysUserByBzMerchantIdDto" type="{itaf.framework.ws.server.cart}sysUserDto" minOccurs="0"/>
 *         &lt;element name="bzUserTakeDeliveryAddressDto" type="{itaf.framework.ws.server.cart}bzUserTakeDeliveryAddressDto" minOccurs="0"/>
 ...
 *         &lt;element name="bzConsumerCreditEvalDtos" type="{itaf.framework.ws.server.cart}bzConsumerCreditEvalDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzOrderHistorieDtos" type="{itaf.framework.ws.server.cart}bzOrderHistoryDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzDistComCreditEvalDtos" type="{itaf.framework.ws.server.cart}bzDistComCreditEvalDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzOrderPaymentDtos" type="{itaf.framework.ws.server.cart}bzOrderPaymentDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzMerchantCreditEvalDtos" type="{itaf.framework.ws.server.cart}bzMerchantCreditEvalDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzInvoiceDtos" type="{itaf.framework.ws.server.cart}bzInvoiceDto" maxOccurs="unbounded" minOccurs="0"/>
