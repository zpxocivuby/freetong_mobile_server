 ...
 *       &lt;sequence>
 *         &lt;element name="sysUserByBzConsumerIdDto" type="{itaf.framework.ws.server.order}sysUserDto" minOccurs="0"/>
 *         &lt;element name="sysUserByBzMerchantIdDto" type="{itaf.framework.ws.server.order}sysUserDto" minOccurs="0"/>
 *         &lt;element name="bzUserTakeDeliveryAddressDto" type="{itaf.framework.ws.server.order}bzUserTakeDeliveryAddressDto" minOccurs="0"/>
 ...
 *         &lt;element name="bzConsumerCreditEvalDtos" type="{itaf.framework.ws.server.order}bzConsumerCreditEvalDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzOrderHistorieDtos" type="{itaf.framework.ws.server.order}bzOrderHistoryDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzDistComCreditEvalDtos" type="{itaf.framework.ws.server.order}bzDistComCreditEvalDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzOrderPaymentDtos" type="{itaf.framework.ws.server.order}bzOrderPaymentDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzMerchantCreditEvalDtos" type="{itaf.framework.ws.server.order}bzMerchantCreditEvalDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzInvoiceDtos" type="{itaf.framework.ws.server.order}bzInvoiceDto" maxOccurs="unbounded" minOccurs="0"/>
