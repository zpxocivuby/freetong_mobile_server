 ...
 * generated in the itaf.WsPaymentTypeService package. 
...
public class ObjectFactory {
    ...
    private static final QName _FindList_QNAME = new QName("itaf.framework.ws.server.order", "findList");
    private static final QName _FindListResponse_QNAME = new QName("itaf.framework.ws.server.order", "findListResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: itaf.WsPaymentTypeService
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.order", name = "findList")
     ...
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.order", name = "findListResponse")
