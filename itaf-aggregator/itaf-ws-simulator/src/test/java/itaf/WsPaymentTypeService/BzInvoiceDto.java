 ...
 *         &lt;element name="bzOrderDto" type="{itaf.framework.ws.server.order}bzOrderDto" minOccurs="0"/>
 *         &lt;element name="sysUserByBzDistributionCompanyIdDto" type="{itaf.framework.ws.server.order}sysUserDto" minOccurs="0"/>
 *         &lt;element name="bzDistributionModelDto" type="{itaf.framework.ws.server.order}bzDistributionModelDto" minOccurs="0"/>
 ...
 *         &lt;element name="bzDistributionOrderDtos" type="{itaf.framework.ws.server.order}bzDistributionOrderDto" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
