 ...
 * generated in the itaf.WsProductService package. 
...
public class ObjectFactory {
    ...
    private static final QName _GetById_QNAME = new QName("itaf.framework.ws.server.product", "getById");
    private static final QName _GetByIdResponse_QNAME = new QName("itaf.framework.ws.server.product", "getByIdResponse");
    private static final QName _RemoveProductsFromShelf_QNAME = new QName("itaf.framework.ws.server.product", "removeProductsFromShelf");
    private static final QName _RemoveProductsFromShelfResponse_QNAME = new QName("itaf.framework.ws.server.product", "removeProductsFromShelfResponse");
    private static final QName _CreateOrUpdateResponse_QNAME = new QName("itaf.framework.ws.server.product", "createOrUpdateResponse");
    private static final QName _PutProductsOnShelfResponse_QNAME = new QName("itaf.framework.ws.server.product", "putProductsOnShelfResponse");
    private static final QName _CreateOrUpdate_QNAME = new QName("itaf.framework.ws.server.product", "createOrUpdate");
    private static final QName _DeleteByIdsResponse_QNAME = new QName("itaf.framework.ws.server.product", "deleteByIdsResponse");
    private static final QName _DeleteByIds_QNAME = new QName("itaf.framework.ws.server.product", "deleteByIds");
    private static final QName _PutProductsOnShelf_QNAME = new QName("itaf.framework.ws.server.product", "putProductsOnShelf");
    private static final QName _BzUserPositionDtoId_QNAME = new QName("", "id");
    ...
    private static final QName _BzUserPositionDtoSysUserDto_QNAME = new QName("", "sysUserDto");
    ...
    private static final QName _BzProductDtoBzStockOrderItemDtos_QNAME = new QName("", "bzStockOrderItemDtos");
    ...
    private static final QName _BzProductDtoTrProductStockDtos_QNAME = new QName("", "trProductStockDtos");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: itaf.WsProductService
     * 
     */
    ...
    /**
     * Create an instance of {@link DeleteByIdsResponse }
     * 
     */
    public DeleteByIdsResponse createDeleteByIdsResponse() {
        return new DeleteByIdsResponse();
    }
    ...
    /**
     * Create an instance of {@link PutProductsOnShelf }
     * 
     */
    public PutProductsOnShelf createPutProductsOnShelf() {
        return new PutProductsOnShelf();
    }

    /**
     * Create an instance of {@link DeleteByIds }
     * 
     */
    public DeleteByIds createDeleteByIds() {
        return new DeleteByIds();
    }
    ...
    /**
     * Create an instance of {@link RemoveProductsFromShelfResponse }
     * 
     */
    public RemoveProductsFromShelfResponse createRemoveProductsFromShelfResponse() {
        return new RemoveProductsFromShelfResponse();
    }

    /**
     * Create an instance of {@link RemoveProductsFromShelf }
     * 
     */
    public RemoveProductsFromShelf createRemoveProductsFromShelf() {
        return new RemoveProductsFromShelf();
    }
    ...
    /**
     * Create an instance of {@link PutProductsOnShelfResponse }
     * 
     */
    public PutProductsOnShelfResponse createPutProductsOnShelfResponse() {
        return new PutProductsOnShelfResponse();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.product", name = "getById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.product", name = "getByIdResponse")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link RemoveProductsFromShelf }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.product", name = "removeProductsFromShelf")
    public JAXBElement<RemoveProductsFromShelf> createRemoveProductsFromShelf(RemoveProductsFromShelf value) {
        return new JAXBElement<RemoveProductsFromShelf>(_RemoveProductsFromShelf_QNAME, RemoveProductsFromShelf.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link RemoveProductsFromShelfResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.product", name = "removeProductsFromShelfResponse")
    public JAXBElement<RemoveProductsFromShelfResponse> createRemoveProductsFromShelfResponse(RemoveProductsFromShelfResponse value) {
        return new JAXBElement<RemoveProductsFromShelfResponse>(_RemoveProductsFromShelfResponse_QNAME, RemoveProductsFromShelfResponse.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link CreateOrUpdateResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.product", name = "createOrUpdateResponse")
    public JAXBElement<CreateOrUpdateResponse> createCreateOrUpdateResponse(CreateOrUpdateResponse value) {
        return new JAXBElement<CreateOrUpdateResponse>(_CreateOrUpdateResponse_QNAME, CreateOrUpdateResponse.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link PutProductsOnShelfResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.product", name = "putProductsOnShelfResponse")
    public JAXBElement<PutProductsOnShelfResponse> createPutProductsOnShelfResponse(PutProductsOnShelfResponse value) {
        return new JAXBElement<PutProductsOnShelfResponse>(_PutProductsOnShelfResponse_QNAME, PutProductsOnShelfResponse.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link CreateOrUpdate }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.product", name = "createOrUpdate")
    public JAXBElement<CreateOrUpdate> createCreateOrUpdate(CreateOrUpdate value) {
        return new JAXBElement<CreateOrUpdate>(_CreateOrUpdate_QNAME, CreateOrUpdate.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link DeleteByIdsResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.product", name = "deleteByIdsResponse")
    public JAXBElement<DeleteByIdsResponse> createDeleteByIdsResponse(DeleteByIdsResponse value) {
        return new JAXBElement<DeleteByIdsResponse>(_DeleteByIdsResponse_QNAME, DeleteByIdsResponse.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link DeleteByIds }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.product", name = "deleteByIds")
    public JAXBElement<DeleteByIds> createDeleteByIds(DeleteByIds value) {
        return new JAXBElement<DeleteByIds>(_DeleteByIds_QNAME, DeleteByIds.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link PutProductsOnShelf }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.product", name = "putProductsOnShelf")
    public JAXBElement<PutProductsOnShelf> createPutProductsOnShelf(PutProductsOnShelf value) {
        return new JAXBElement<PutProductsOnShelf>(_PutProductsOnShelf_QNAME, PutProductsOnShelf.class, null, value);
    }
    ...
    public JAXBElement<Long> createBzUserPositionDtoId(Long value) {
        return new JAXBElement<Long>(_BzUserPositionDtoId_QNAME, Long.class, BzUserPositionDto.class, value);
    }
    ...
    public JAXBElement<SysUserDto> createBzUserPositionDtoSysUserDto(SysUserDto value) {
        return new JAXBElement<SysUserDto>(_BzUserPositionDtoSysUserDto_QNAME, SysUserDto.class, BzUserPositionDto.class, value);
    }
    ...
    public JAXBElement<BzStockOrderItemDto> createBzProductDtoBzStockOrderItemDtos(BzStockOrderItemDto value) {
        return new JAXBElement<BzStockOrderItemDto>(_BzProductDtoBzStockOrderItemDtos_QNAME, BzStockOrderItemDto.class, BzProductDto.class, value);
    }
    ...
    public JAXBElement<Long> createBzProductDtoId(Long value) {
        return new JAXBElement<Long>(_BzUserPositionDtoId_QNAME, Long.class, BzProductDto.class, value);
    }
    ...
    public JAXBElement<TrProductStockDto> createBzProductDtoTrProductStockDtos(TrProductStockDto value) {
        return new JAXBElement<TrProductStockDto>(_BzProductDtoTrProductStockDtos_QNAME, TrProductStockDto.class, BzProductDto.class, value);
    }
    ...
    public JAXBElement<SysUserDto> createBzProductDtoSysUserDto(SysUserDto value) {
        return new JAXBElement<SysUserDto>(_BzUserPositionDtoSysUserDto_QNAME, SysUserDto.class, BzProductDto.class, value);
    }
    ...
    public JAXBElement<Long> createBzShelfDtoId(Long value) {
        return new JAXBElement<Long>(_BzUserPositionDtoId_QNAME, Long.class, BzShelfDto.class, value);
    }
    ...
    public JAXBElement<BzStockOrderItemDto> createBzShelfDtoBzStockOrderItemDtos(BzStockOrderItemDto value) {
        return new JAXBElement<BzStockOrderItemDto>(_BzProductDtoBzStockOrderItemDtos_QNAME, BzStockOrderItemDto.class, BzShelfDto.class, value);
    }
    ...
    public JAXBElement<SysUserDto> createBzShelfDtoSysUserDto(SysUserDto value) {
        return new JAXBElement<SysUserDto>(_BzUserPositionDtoSysUserDto_QNAME, SysUserDto.class, BzShelfDto.class, value);
    }
    ...
    public JAXBElement<Long> createBzPositionDtoId(Long value) {
        return new JAXBElement<Long>(_BzUserPositionDtoId_QNAME, Long.class, BzPositionDto.class, value);
    }
    ...
    public JAXBElement<Long> createBzStockDtoId(Long value) {
        return new JAXBElement<Long>(_BzUserPositionDtoId_QNAME, Long.class, BzStockDto.class, value);
    }
    ...
    public JAXBElement<TrProductStockDto> createBzStockDtoTrProductStockDtos(TrProductStockDto value) {
        return new JAXBElement<TrProductStockDto>(_BzProductDtoTrProductStockDtos_QNAME, TrProductStockDto.class, BzStockDto.class, value);
    }
    ...
    public JAXBElement<SysUserDto> createBzStockDtoSysUserDto(SysUserDto value) {
        return new JAXBElement<SysUserDto>(_BzUserPositionDtoSysUserDto_QNAME, SysUserDto.class, BzStockDto.class, value);
    }
    ...
    public JAXBElement<Long> createBzProductFavoriteDtoId(Long value) {
        return new JAXBElement<Long>(_BzUserPositionDtoId_QNAME, Long.class, BzProductFavoriteDto.class, value);
    }
    ...
    public JAXBElement<SysUserDto> createBzProductFavoriteDtoSysUserDto(SysUserDto value) {
        return new JAXBElement<SysUserDto>(_BzUserPositionDtoSysUserDto_QNAME, SysUserDto.class, BzProductFavoriteDto.class, value);
    }
