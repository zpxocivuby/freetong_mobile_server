 ...
 *       &lt;sequence>
 *         &lt;element name="sysUserByBzConsumerIdDto" type="{itaf.framework.ws.server.search}sysUserDto" minOccurs="0"/>
 *         &lt;element name="sysUserByBzMerchantIdDto" type="{itaf.framework.ws.server.search}sysUserDto" minOccurs="0"/>
 *         &lt;element name="bzUserTakeDeliveryAddressDto" type="{itaf.framework.ws.server.search}bzUserTakeDeliveryAddressDto" minOccurs="0"/>
 ...
 *         &lt;element name="bzOrderHistorieDtos" type="{itaf.framework.ws.server.search}bzOrderHistoryDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzDistComCreditEvalDtos" type="{itaf.framework.ws.server.search}bzDistComCreditEvalDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzOrderPaymentDtos" type="{itaf.framework.ws.server.search}bzOrderPaymentDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzMerchantCreditEvalDtos" type="{itaf.framework.ws.server.search}bzMerchantCreditEvalDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzInvoiceDtos" type="{itaf.framework.ws.server.search}bzInvoiceDto" maxOccurs="unbounded" minOccurs="0"/>
