 ...
 *         &lt;element name="bzUserPositionDtos" type="{itaf.framework.ws.server.search}bzUserPositionDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzUserDeliveryAddresseDtos" type="{itaf.framework.ws.server.search}bzUserDeliveryAddressDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzProductDtos" type="{itaf.framework.ws.server.search}bzProductDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzUserTakeDeliveryAddresseDtos" type="{itaf.framework.ws.server.search}bzUserTakeDeliveryAddressDto" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
