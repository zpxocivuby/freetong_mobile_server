 ...
 *         &lt;element name="bzDistComCreditDto" type="{itaf.framework.ws.server.order}bzDistComCreditDto" minOccurs="0"/>
 *         &lt;element name="bzOrder" type="{itaf.framework.ws.server.order}bzOrderDto" minOccurs="0"/>
