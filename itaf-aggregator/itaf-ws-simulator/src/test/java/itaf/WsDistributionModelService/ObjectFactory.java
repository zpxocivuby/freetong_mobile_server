 ...
 * generated in the itaf.WsDistributionModelService package. 
...
public class ObjectFactory {
    ...
    private static final QName _FindList_QNAME = new QName("itaf.framework.ws.server.merchant", "findList");
    private static final QName _FindListResponse_QNAME = new QName("itaf.framework.ws.server.merchant", "findListResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: itaf.WsDistributionModelService
     * 
     */
    ...
    /**
     * Create an instance of {@link FindListResponse }
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.merchant", name = "findList")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link FindListResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "itaf.framework.ws.server.merchant", name = "findListResponse")
    public JAXBElement<FindListResponse> createFindListResponse(FindListResponse value) {
        return new JAXBElement<FindListResponse>(_FindListResponse_QNAME, FindListResponse.class, null, value);
    }
