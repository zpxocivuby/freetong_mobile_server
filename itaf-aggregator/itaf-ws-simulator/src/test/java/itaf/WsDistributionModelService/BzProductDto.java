 ...
 *       &lt;sequence>
 *         &lt;element name="bzMerchantDto" type="{itaf.framework.ws.server.merchant}bzMerchantDto" minOccurs="0"/>
 ...
 *         &lt;element name="bzProductBrandDtos" type="{itaf.framework.ws.server.merchant}bzProductBrandDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="trProductStockDtos" type="{itaf.framework.ws.server.merchant}trProductStockDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzProductCategorieDtos" type="{itaf.framework.ws.server.merchant}bzProductCategoryDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzProductAttachmentDtos" type="{itaf.framework.ws.server.merchant}bzProductAttachmentDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzProductEvaluationDtos" type="{itaf.framework.ws.server.merchant}bzProductEvaluationDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzInvoiceItemDtos" type="{itaf.framework.ws.server.merchant}bzInvoiceItemDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzPositionDtos" type="{itaf.framework.ws.server.merchant}bzPositionDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzCartDtos" type="{itaf.framework.ws.server.merchant}bzCartItemDto" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="bzProductFavoriteDtos" type="{itaf.framework.ws.server.merchant}bzProductFavoriteDto" maxOccurs="unbounded" minOccurs="0"/>
