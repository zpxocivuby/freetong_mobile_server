 ...
 *         &lt;element name="bzUserPositionDtos" type="{itaf.framework.ws.server.product}bzUserPositionDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzUserDeliveryAddresseDtos" type="{itaf.framework.ws.server.product}bzUserDeliveryAddressDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzProductDtos" type="{itaf.framework.ws.server.product}bzProductDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bzUserTakeDeliveryAddresseDtos" type="{itaf.framework.ws.server.product}bzUserTakeDeliveryAddressDto" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends OperateDto
{
     ...
     * http://localhost:8080/itaf-web-side/service/WsProductCategoryService?wsdl=WsProductCategoryService.wsdl#types1的第 0 行
     * http://localhost:8080/itaf-web-side/service/WsProductCategoryService?wsdl=WsProductCategoryService.wsdl#types1的第 0 行
     * <p>
