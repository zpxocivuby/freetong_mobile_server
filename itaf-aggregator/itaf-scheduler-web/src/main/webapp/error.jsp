...
<%
	String errorNo = "";
	String errorNoDetail = "";
	String errorMsg = "";
	if (exception instanceof BusinessException) {
		BusinessException businessException = (BusinessException) exception;
		errorMsg = businessException.getMessage();
	} else if (exception instanceof AppException) {
		AppException systemException = (AppException) exception;
	...
	if (errorNoDetail == null || errorNoDetail == "") {
		errorNoDetail = "系统发生异常,无法执行相应操作.";
	}
%>
...
function showErrorInfoDetail(obj) {
	if (document.getElementById("showDetailId") && document.getElementById("errorMsgImgId")) {
		if ("hidden" == obj.lang) {
		...
		<div class="main1_content1">
			...
			<div class="m1_ct1_center">
				...
				<div class="m1_msg2">
					...
					<div id="showDetailId" class="m1_msg2_content" style="display: none;">
